...
import md5 from 'md5'
 ...
 class Register extends React.Component {
	...
	saveUser=createUser=>{
		...
		return this.state.useRef.child(createUser.user.uid).set({
			name:createUser.user.display,
			...
			<Grid.Column style={{maxWidth:450}}>
					...
					<Form onSubmit={this.handleSubmit} size="large">
						...
						<Segment slacked>
							...
							<Form.Input fluid name="passwordConfirmation" value={passwordConfirmation} icon="lock" iconPosition="repeat" className={this.handleInputError(errors,'password')} placeholder="Password Confirmation" onChange={this.handleChange} type="password" />
