		...
		return (
			<div className="messageSender">
				...
				<div className="messageSender__top">
					...
					<form>
						<input value={input} onChange={e=>setInput(e.target.value)} className="meessageSender__input" placeholder={user.displayName}/>
				...
				<div className="messageSender__bottom">
					...
					<div className="messageSender__option">
						<InsertEmoticonIcon style={{color:"oreang"}} /><h3>Feeling/Activity</h3>
					</div>
